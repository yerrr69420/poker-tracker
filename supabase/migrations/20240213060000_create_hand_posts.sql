-- Run this in Supabase Dashboard → SQL Editor if you get "could not find table hand_posts"
-- Creates hand_posts, hand_comments, triggers, and RLS (safe to run; skips if objects exist)
